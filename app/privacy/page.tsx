        ...
        <Container maxWidth="md" sx={{ mt: "4rem" }}>
          ...
          <Box component={"section"} id="privacy-information-we-collect">
            ...
            <Typography variant="body1">
              ...
              address, mailing address, phone number, credit card information or social security number. You may,
              however, visit our site anonymously. Google, as a third party vendor, uses cookies to serve ads on your
              site. Google&apos;s use of the DART cookie enables it to serve ads to your users based on their visit to
              your sites and other sites on the Internet. Users may opt out of the use of the DART cookie by visiting
          ...
          <Box component={"section"} id="privacy-information-use">
            ...
            <Typography variant="body1">
              ...
              delivering the purchased product or service requested, to administer a contest, promotion, survey or other
            ...
            <br></br>
            <Typography variant="body1">
              <span className="font-bold">Note:</span> If at any time you would like to unsubscribe from receiving
          ...
          <Typography variant="body1">
            ...
            Socket Layer (SSL) technology and then encrypted into our Database to be only accessed by those authorized
          ...
          <Typography variant="body1">
            ...
            through your Web browser (if you allow them) that enable the sites or service providers systems to recognize
          ...
          <Typography variant="body1">
            ...
            and site interaction so that we can offer better site experiences and tools in the future. We may contract
            with third-party service providers to assist us in better understanding our site visitors. These service
          ...
          <Typography variant="body1">
            ...
            some of our services may not function properly. However, you can still place orders over the telephone or by
